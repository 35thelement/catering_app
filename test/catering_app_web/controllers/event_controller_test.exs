defmodule CateringAppWeb.EventControllerTest do
  use CateringAppWeb.ConnCase

  alias CateringApp.Events

  @create_attrs %{approved: true, caterer_turn: true, day: ~D[2010-04-17], feedback: "some feedback", name: "some name", preferences: "some preferences"}
  ...
  describe "update event" do
    ...
    test "redirects when data is valid", %{conn: conn, event: event} do
      ...
      assert html_response(conn, 200) =~ "some updated feedback"
    end
